!function (e, t) {
    ...
    ut.fn.extend({
        ...
        attr: function (e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s)return typeof e.getAttribute === V ? ut.prop(e, n, r) : (o = 1 !== s || !ut.isXMLDoc(e),
            o && (n = n.toLowerCase(), i = ut.attrHooks[n] || (Ht.test(n) ? St : Et)), r === t ? i && o && "get"in i && null !== (a = i.get(e, n)) ? a : (typeof e.getAttribute !== V && (a = e.getAttribute(n)),
        ...
        removeAttr: function (e, t) {
            ...
            if (o && 1 === e.nodeType)for (; n = o[i++];)r = ut.propFix[n] || n, Ht.test(n) ? !Mt && qt.test(n) ? e[ut.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ut.attr(e, n, ""),
        ...
        set: function (e, t, n) {
            return t === !1 ? ut.removeAttr(e, n) : _t && Mt || !qt.test(n) ? e.setAttribute(!Mt && ut.propFix[n] || n, n) : e[ut.camelCase("default-" + n)] = e[n] = !0,
                n;
        }
    ...
    ut.event = {
        ...
        E = a.isXML = function (e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, q = E(r),
            ...
            pseudos: {
                ...
                lang: i(function (e) {
                    return ft.test(e || "") || a.error("unsupported lang: " + e), e = e.replace(xt, wt).toLowerCase(),
                        function (t) {
                            var n;
                            do if (n = q ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang)return n = n.toLowerCase(),
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td,
        ...
        clone: function (e, t, n) {
            ...
            if (ut.support.html5Clone || ut.isXMLDoc(e) || !Yt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ln.innerHTML = e.outerHTML,
    ...
    Ln = Wn.exec(Hn.toLowerCase()) || [], ut.fn.load = function (e, n, r) {
        ...
        return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)), ut.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (a = "POST"),
        s.length > 0 && ut.ajax({
            url: e,
            type: a,
            dataType: "html",
        ...
        ajax: function (e, n) {
            function r(e, n, r, i) {
                var o, f, v, b, w, N = n;
                2 !== x && (x = 2, u && clearTimeout(u), c = t, s = i || "", T.readyState = e > 0 ? 4 : 0, r && (b = q(p, T, r)),
                    e >= 200 && 300 > e || 304 === e ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (ut.lastModified[a] = w),
                        ...
                        N = "notmodified") : (o = M(p, b), N = o.state, f = o.data, v = o.error, o = !v)) : (v = N, (e || !N) && (N = "error",
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Hn) + "").replace(_n, "").replace(Rn, Ln[1] + "//"),
            ...
            l = p.global, l && 0 === ut.active++ && ut.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(),
                p.hasContent = !Pn.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (Mn.test(a) ? "&" : "?") + p.data,
                delete p.data), p.cache === !1 && (p.url = Fn.test(a) ? a.replace(Fn, "$1_=" + qn++) : a + (Mn.test(a) ? "&" : "?") + "_=" + qn++)),
    ...
    ut.ajaxSetup({
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback,
            u ? n[u] = n[u].replace(Yn, "$1" + o) : n.jsonp !== !1 && (n.url += (Mn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
    ...
    } : _, Gn = ut.ajaxSettings.xhr(), ut.support.cors = !!Gn && "withCredentials"in Gn, Gn = ut.support.ajax = !!Gn,
    ...
    ut.Animation = ut.extend(P, {
        ...
        if (a)return n = a.documentElement, ut.contains(n, o) ? (typeof o.getBoundingClientRect !== V && (i = o.getBoundingClientRect()),
            r = z(a), {
    ...
    }), e.jQuery = e.$ = ut, "function" == typeof define && define.amd && define.amd.jQuery && define("biz_common/jquery-1.9.1.js", [], function () {
        return ut;
    });
}(window);